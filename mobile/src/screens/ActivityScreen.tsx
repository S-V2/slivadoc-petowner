...
const styles = StyleSheet.create({
  ...
  headerCopy: { flex: 1 },
  headerEyebrow: { color: colors.sky600, fontSize: 9, fontWeight: "600", letterSpacing: 1.2 },
  headerTitle: { marginTop: 3, color: colors.navy, fontSize: 21, lineHeight: 26, fontWeight: "700", letterSpacing: -0.4 },
  ...
  sectionEyebrow: { color: colors.muted, fontSize: 9, fontWeight: "600", letterSpacing: 1.1 },
  sectionTitle: { marginTop: 2, color: colors.navy, fontSize: typography.sectionTitle, lineHeight: 22, fontWeight: "700" },
  ...
  activityType: { fontSize: 9, fontWeight: "600", letterSpacing: 0.7, textTransform: "uppercase" },
  activityCode: { flexShrink: 1, color: colors.muted, fontSize: 9, fontWeight: "600" },
  activityTitle: { marginTop: 4, color: colors.navy, fontSize: 13, lineHeight: 18, fontWeight: "700" },
  ...
  activityHint: { flexShrink: 1, color: colors.text, fontSize: 10, fontWeight: "600" },
  ...
  createSheetTitle: { marginTop: 2, color: colors.navy, fontSize: 18, fontWeight: "700" },
  ...
  sheetTitle: { marginTop: 2, color: colors.navy, fontSize: 16, fontWeight: "700" },
  ...
  detailTitle: { marginTop: 10, color: colors.navy, fontSize: 20, lineHeight: 25, fontWeight: "700", letterSpacing: -0.3 },
  detailSubtitle: { marginTop: 3, color: colors.text, fontSize: 11, lineHeight: 16 },
  detailAmount: { marginTop: 11, color: colors.navy, fontSize: 17, fontWeight: "700" },
  detailSection: { marginTop: 18 },
  detailSectionTitle: { marginBottom: 7, color: colors.navy, fontSize: 14, fontWeight: "700" },
  ...
  productName: { color: colors.navy, fontSize: 12, lineHeight: 16, fontWeight: "600" },
  productStore: { marginTop: 2, color: colors.muted, fontSize: 9 },
  productPrice: { marginTop: 3, color: colors.text, fontSize: 11, fontWeight: "600" },
  ...
  paymentValue: { marginTop: 2, color: colors.navy, fontSize: 11, fontWeight: "600", textTransform: "capitalize" },
