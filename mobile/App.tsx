...
const styles = StyleSheet.create({
  ...
  backText: { color: colors.navy, fontSize: 12, fontWeight: "600" },
  ...
  loginTabText: { color: colors.muted, fontSize: 11, fontWeight: "600" },
  loginTabTextActive: { color: colors.sky600, fontWeight: "700" },
  loginInput: {
    minHeight: 44,
    paddingHorizontal: 12,
    borderWidth: 1,
  ...
  chatName: { color: colors.navy, fontSize: 14, fontWeight: "700" },
  ...
  petContextLabel: { color: colors.muted, fontSize: 11, fontWeight: "700" },
  petContextName: {
    marginTop: 3,
    color: colors.navy,
    fontSize: 13,
  ...
  changePet: { color: colors.sky600, fontSize: 13, fontWeight: "600" },
  ...
  stepNumber: { color: colors.muted, fontSize: 13, fontWeight: "700" },
  ...
  selectedPetName: { color: colors.navy, fontSize: 13, fontWeight: "700" },
  ...
  serviceOptionName: { color: colors.navy, fontSize: 12, fontWeight: "700" },
