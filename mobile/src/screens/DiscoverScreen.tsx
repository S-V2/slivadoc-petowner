...
const styles = StyleSheet.create({
  title: { marginTop: 11, color: colors.navy, fontSize: 31, lineHeight: 31, fontWeight: "900", letterSpacing: -0.7 },
  subtitle: { marginTop: 7, color: colors.muted, fontSize: 14 },
  ...
  activeCategory: { borderColor: colors.sky500, backgroundColor: colors.sky500 }, categoryText: { color: colors.muted, fontSize: 13, fontWeight: "700" }, activeCategoryText: { color: colors.white },
  resultHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }, resultCount: { color: colors.muted, fontSize: 13 }, resultStrong: { color: colors.text, fontWeight: "800" }, sort: { color: colors.sky600, fontSize: 12, fontWeight: "700" },
  ...
  serviceBody: { padding: 15 }, serviceTitleRow: { flexDirection: "row", gap: 10 }, serviceTitleCopy: { flex: 1 }, serviceName: { color: colors.navy, fontSize: 18, fontWeight: "900" }, serviceLocation: { marginTop: 4, color: colors.muted, fontSize: 12 }, rating: { width: 45, height: 32, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 3, borderRadius: 10, backgroundColor: colors.yellow50 }, ratingText: { color: "#A57417", fontSize: 13, fontWeight: "800" },
  tags: { flexDirection: "row", gap: 5, marginTop: 11 }, status: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 11 }, liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.mint }, statusText: { color: "#19866F", fontSize: 12, fontWeight: "700" },
  serviceFooter: { flexDirection: "row", alignItems: "flex-end", justifyContent: "space-between", marginTop: 13, paddingTop: 12, borderTopWidth: 1, borderTopColor: colors.line }, priceLabel: { color: colors.muted, fontSize: 11 }, price: { marginTop: 3, color: colors.navy, fontSize: 14, fontWeight: "800" },
  empty: { minHeight: 300, alignItems: "center", justifyContent: "center" }, emptyEmoji: { fontSize: 48 }, emptyTitle: { marginTop: 10, color: colors.navy, fontSize: 21, fontWeight: "800" }, emptyNote: { marginTop: 4, marginBottom: 15, color: colors.muted, fontSize: 14 },
});
