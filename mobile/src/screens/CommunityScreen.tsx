...
const styles = StyleSheet.create({
  ...
  subtitle: { marginTop: 4, color: colors.muted, fontSize: 13, lineHeight: 20 },
  ...
  userText: { color: colors.sky600, fontSize: 13, fontWeight: "900" },
  promptText: { flex: 1, color: colors.muted, fontSize: 13, lineHeight: 19 },
  post: {
    marginTop: 14,
    padding: 15,
    borderWidth: 1,
  ...
  author: { color: colors.navy, fontSize: 14, fontWeight: "900" },
  meta: { marginTop: 3, color: colors.muted, fontSize: 11, lineHeight: 17 },
  tag: {
    maxWidth: 92,
    paddingHorizontal: 8,
    paddingVertical: 6,
  ...
  tagText: { color: colors.sky600, fontSize: 11, fontWeight: "800" },
  body: {
    marginVertical: 13,
    color: colors.text,
    fontSize: 14,
  ...
  composerPage: { flex: 1, padding: 20, backgroundColor: colors.white },
  composerHeader: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
