...
const styles = StyleSheet.create({
  ...
  brand: { color: colors.navy, fontSize: 24, lineHeight: 29, fontWeight: "700", letterSpacing: -0.7 },
  ...
  authorName: { maxWidth: "90%", color: colors.navy, fontSize: 12, fontWeight: "700" },
  ...
  reelLabelText: { color: colors.white, fontSize: 9, fontWeight: "600", letterSpacing: 0.8 },
  ...
  countText: { paddingHorizontal: 12, color: colors.navy, fontSize: 11, fontWeight: "700" },
  ...
  sheetTitle: { marginTop: 2, color: colors.navy, fontSize: 18, lineHeight: 22, fontWeight: "700" },
  ...
  pickerTitle: { marginTop: 10, color: colors.navy, fontSize: 13, fontWeight: "700" },
