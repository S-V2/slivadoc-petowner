  ...
  return <>
    <Screen>
      ...
      <Card style={styles.profileCard}>
        <LinearGradient colors={[colors.sky500, "#68CCF7", colors.violet]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.cover}><Text style={styles.coverText}>PET PARENT CLUB ✦</Text></LinearGradient>
    ...
    <Screen>
      ...
      {selectedPet ? <>
        ...
        <Card style={styles.inviteCard}>
          <FieldLabel label="Nama lengkap"/><TextInput value={name} onChangeText={setName} placeholder="Nama anggota keluarga" placeholderTextColor="#95A6B5" style={styles.input}/>
          <FieldLabel label="Email"/><TextInput value={email} onChangeText={setEmail} autoCapitalize="none" autoCorrect={false} keyboardType="email-address" placeholder="nama@email.com" placeholderTextColor="#95A6B5" style={styles.input}/>
