...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 64, flexDirection: "row", alignItems: "center", gap: 9, paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: colors.sky100, backgroundColor: colors.white }, avatar: { position: "relative", width: 41, height: 41, borderRadius: 15, alignItems: "center", justifyContent: "center", backgroundColor: colors.mint50 }, dot: { position: "absolute", right: -2, bottom: -2, width: 10, height: 10, borderRadius: 5, borderWidth: 2, borderColor: colors.white, backgroundColor: "#AAB6C0" }, dotOnline: { backgroundColor: colors.mint }, headerCopy: { minWidth: 0, flex: 1 }, name: { color: colors.navy, fontSize: 15, fontWeight: "700" }, status: { marginTop: 2, color: colors.mint, fontSize: 10 }, iconButton: { width: 40, height: 40, borderRadius: 15, borderWidth: 1, borderColor: colors.sky100, alignItems: "center", justifyContent: "center", backgroundColor: colors.white },
  tabs: { flexDirection: "row", gap: 6, padding: 8, backgroundColor: colors.canvas }, tab: { flex: 1, minHeight: 40, flexDirection: "row", gap: 6, alignItems: "center", justifyContent: "center", borderRadius: 14 }, activeTab: { borderWidth: 1, borderColor: colors.sky100, backgroundColor: colors.white, ...shadow }, tabText: { color: colors.muted, fontSize: 11, fontWeight: "600" }, activeTabText: { color: colors.sky600 },
