...
const styles = StyleSheet.create({
  ...
  topKicker: { color: colors.muted, fontSize: 9, fontWeight: "600" },
  topTitle: { color: colors.navy, fontSize: 13, fontWeight: "800" },
  ...
  eyebrow: { color: colors.muted, fontSize: 8, fontWeight: "800", letterSpacing: 1.1, marginBottom: 3 },
  sectionHeading: { color: colors.navy, fontSize: 18, fontWeight: "800", letterSpacing: -0.35 },
  sectionAction: { color: colors.sky600, fontSize: 10, fontWeight: "700", paddingBottom: 2 },
  ...
  softButtonText: { color: colors.sky600, fontSize: 10, fontWeight: "800" },
  ...
  emptyNote: { maxWidth: 280, marginTop: 5, marginBottom: 16, color: colors.muted, fontSize: 11, lineHeight: 17, textAlign: "center" },
});
