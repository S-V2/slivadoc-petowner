...
const styles = StyleSheet.create({
  ...
  profileCard: { marginTop: 8, overflow: "hidden" }, cover: { height: 68, padding: 13 }, coverText: { color: "rgba(255,255,255,.9)", fontSize: 9, fontWeight: "600", letterSpacing: 1 }, profileRow: { flexDirection: "row", alignItems: "center", marginTop: -28, paddingHorizontal: 13, paddingBottom: 12 }, avatar: { width: 64, height: 64, borderRadius: 21, borderWidth: 4, borderColor: colors.white, alignItems: "center", justifyContent: "center", backgroundColor: colors.sky100 }, avatarText: { color: colors.sky600, fontSize: 20, fontWeight: "700" }, profileCopy: { minWidth: 0, flex: 1, marginLeft: 9, paddingTop: 26, alignItems: "flex-start" }, name: { color: colors.navy, fontSize: typography.cardTitle, lineHeight: 20, fontWeight: "700" }, meta: { marginTop: 2, marginBottom: 5, color: colors.muted, fontSize: typography.caption, lineHeight: 14 }, edit: { marginTop: 26, width: 32, height: 32, borderRadius: 11, alignItems: "center", justifyContent: "center", backgroundColor: colors.sky50 }, stats: { flexDirection: "row", borderTopWidth: 1, borderTopColor: colors.line }, stat: { flex: 1, paddingVertical: 9, borderRightWidth: 1, borderRightColor: colors.line, alignItems: "center" }, statLast: { borderRightWidth: 0 }, statValue: { color: colors.navy, fontSize: 12, fontWeight: "700" }, statLabel: { marginTop: 2, color: colors.muted, fontSize: 8 },
  memberCard: { padding: 14, borderRadius: 22, ...shadow }, memberTop: { flexDirection: "row", alignItems: "center", gap: 8 }, shield: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(255,255,255,.18)" }, shieldText: { color: colors.white }, memberCopy: { minWidth: 0, flex: 1 }, memberName: { color: colors.white, fontSize: 13, fontWeight: "700" }, memberNote: { marginTop: 2, color: "rgba(255,255,255,.9)", fontSize: 9 }, benefits: { gap: 6, marginTop: 10 }, benefit: { flexDirection: "row", alignItems: "center", gap: 6 }, benefitCheck: { width: 17, height: 17, borderRadius: 6, alignItems: "center", justifyContent: "center", backgroundColor: colors.white }, benefitText: { flex: 1, color: "rgba(255,255,255,.9)", fontSize: 10, lineHeight: 14 },
  settings: { paddingHorizontal: 11 }, setting: { minHeight: 60, flexDirection: "row", alignItems: "center", gap: 9, borderBottomWidth: 1, borderBottomColor: colors.line }, settingIcon: { width: 35, height: 35, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: colors.sky50 }, settingCopy: { minWidth: 0, flex: 1 }, settingTitle: { color: colors.navy, fontSize: 12, fontWeight: "600" }, settingNote: { marginTop: 2, color: colors.muted, fontSize: 9, lineHeight: 13 },
  ...
  petSelector: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, petChip: { minHeight: 42, flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 10, borderWidth: 1, borderColor: colors.line, borderRadius: 13, backgroundColor: colors.white }, petChipActive: { borderColor: colors.sky400, backgroundColor: colors.sky50 }, petChipEmoji: { fontSize: 17 }, petChipText: { color: colors.text, fontSize: 11, fontWeight: "600" }, petChipTextActive: { color: colors.sky600 },
  emptyCard: { alignItems: "center", gap: 5, padding: 22 }, emptyTitle: { color: colors.navy, fontSize: 12, fontWeight: "700" }, emptyNote: { marginTop: 3, color: colors.muted, fontSize: 9, lineHeight: 14 }, familyList: { paddingHorizontal: 12 }, loadingRow: { minHeight: 82, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9 }, loadingText: { color: colors.muted, fontSize: 10 }, emptyList: { minHeight: 88, flexDirection: "row", alignItems: "center", gap: 10 }, emptyListIcon: { width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: 14, backgroundColor: colors.sky50 }, emptyListCopy: { minWidth: 0, flex: 1 },
  familyMember: { minHeight: 78, flexDirection: "row", alignItems: "center", gap: 9, borderBottomWidth: 1, borderBottomColor: colors.line }, familyAvatar: { width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: 14, backgroundColor: colors.violet50 }, familyAvatarText: { color: colors.violet, fontSize: 12, fontWeight: "700" }, familyMemberCopy: { minWidth: 0, flex: 1 }, familyMemberHeading: { flexDirection: "row", alignItems: "center", gap: 5 }, familyMemberName: { minWidth: 0, flexShrink: 1, color: colors.navy, fontSize: 11, fontWeight: "700" }, familyStatus: { paddingHorizontal: 5, paddingVertical: 3, borderRadius: 6, backgroundColor: colors.mint50 }, familyStatusText: { color: "#13856F", fontSize: 7, fontWeight: "600", textTransform: "uppercase" }, familyMemberMeta: { marginTop: 2, color: colors.muted, fontSize: 9 }, familyPermissionText: { marginTop: 3, color: colors.sky600, fontSize: 8, fontWeight: "600" }, revokeButton: { width: 34, height: 34, alignItems: "center", justifyContent: "center", borderRadius: 11, backgroundColor: colors.red50 },
  inviteCard: { padding: 13 }, fieldLabel: { marginTop: 10, marginBottom: 6, color: colors.navy, fontSize: 10, fontWeight: "600" }, input: { minHeight: 44, paddingHorizontal: 12, borderWidth: 1, borderColor: colors.line, borderRadius: 13, backgroundColor: "#FBFDFE", color: colors.text, fontSize: typography.input }, roleGrid: { flexDirection: "row", flexWrap: "wrap", gap: 7 }, roleChip: { minHeight: 36, flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 9, borderWidth: 1, borderColor: colors.line, borderRadius: 11, backgroundColor: "#FBFDFE" }, roleChipActive: { borderColor: colors.sky400, backgroundColor: colors.sky50 }, roleChipText: { color: colors.muted, fontSize: 9, fontWeight: "600" }, roleChipTextActive: { color: colors.sky600 }, permissionList: { overflow: "hidden", borderWidth: 1, borderColor: colors.line, borderRadius: 14 }, permissionRow: { minHeight: 58, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 10, borderBottomWidth: 1, borderBottomColor: colors.line }, permissionCopy: { minWidth: 0, flex: 1 }, permissionTitle: { color: colors.navy, fontSize: 10, fontWeight: "600" }, permissionNote: { marginTop: 2, color: colors.muted, fontSize: 8 }, primaryAction: { minHeight: 44, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, marginTop: 13, borderRadius: 13, backgroundColor: colors.sky600, ...shadow }, primaryActionText: { color: colors.white, fontSize: 12, fontWeight: "600" }, formHint: { marginTop: 8, color: colors.muted, fontSize: 8, lineHeight: 12, textAlign: "center" },
  securityHero: { flexDirection: "row", alignItems: "center", gap: 13, padding: 14, borderWidth: 1, borderColor: colors.sky100, borderRadius: 19 }, securityScore: { width: 62, height: 62, alignItems: "center", justifyContent: "center", borderWidth: 5, borderColor: colors.sky400, borderRadius: 31, backgroundColor: colors.white }, securityScoreValue: { color: colors.navy, fontSize: 16, fontWeight: "700" }, securityScoreLabel: { color: colors.muted, fontSize: 7, fontWeight: "600" }, verificationCard: { paddingHorizontal: 12 }, accountRow: { minHeight: 70, flexDirection: "row", alignItems: "center", gap: 9, borderBottomWidth: 1, borderBottomColor: colors.line }, accountIcon: { width: 38, height: 38, alignItems: "center", justifyContent: "center", borderRadius: 13, backgroundColor: colors.sky50 }, accountCopy: { minWidth: 0, flex: 1 }, accountTitle: { color: colors.navy, fontSize: 11, fontWeight: "700" }, accountValue: { marginTop: 3, color: colors.muted, fontSize: 9 },
  controlCard: { paddingHorizontal: 12 }, controlRow: { minHeight: 72, flexDirection: "row", alignItems: "center", gap: 9, borderBottomWidth: 1, borderBottomColor: colors.line }, controlIcon: { width: 38, height: 38, alignItems: "center", justifyContent: "center", borderRadius: 13, backgroundColor: colors.violet50 }, controlCopy: { minWidth: 0, flex: 1 }, controlTitle: { color: colors.navy, fontSize: 11, fontWeight: "700" }, controlNote: { marginTop: 3, color: colors.muted, fontSize: 8, lineHeight: 12 }, securityAction: { minHeight: 70, flexDirection: "row", alignItems: "center", gap: 10, padding: 12, borderWidth: 1, borderColor: colors.sky100, borderRadius: 17, backgroundColor: colors.white, ...shadow }, securityActionIcon: { width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: 14, backgroundColor: colors.sky50 }, securityActionCopy: { minWidth: 0, flex: 1 }, securityActionTitle: { color: colors.navy, fontSize: 11, fontWeight: "600" }, securityActionNote: { marginTop: 3, color: colors.muted, fontSize: 9, lineHeight: 13 },
  sessionCard: { minHeight: 70, flexDirection: "row", alignItems: "center", gap: 10, padding: 12 }, sessionIcon: { width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: 14, backgroundColor: colors.mint50 }, sessionCopy: { minWidth: 0, flex: 1 }, sessionTitle: { color: colors.navy, fontSize: 11, fontWeight: "700" }, sessionNote: { marginTop: 3, color: colors.muted, fontSize: 9 }, activeDot: { width: 9, height: 9, borderRadius: 5, backgroundColor: colors.mint }, sessionHint: { marginTop: 7, paddingHorizontal: 4, color: colors.muted, fontSize: 8, lineHeight: 13 }, securityLogout: { marginBottom: 8 },
  confirmBackdrop: { flex: 1, alignItems: "center", justifyContent: "center", padding: 20, backgroundColor: "rgba(14,32,55,.48)" }, confirmCard: { width: "100%", maxWidth: 390, padding: 18, borderRadius: 22, backgroundColor: colors.white, ...shadow }, confirmIcon: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderRadius: 16, backgroundColor: colors.red50 }, confirmEyebrow: { marginTop: 14, color: colors.red, fontSize: 9, fontWeight: "600", letterSpacing: 1 }, confirmTitle: { marginTop: 5, color: colors.navy, fontSize: 18, lineHeight: 23, fontWeight: "700" }, confirmNote: { marginTop: 7, color: colors.muted, fontSize: 11, lineHeight: 17 }, confirmActions: { flexDirection: "row", gap: 8, marginTop: 18 }, cancelButton: { minHeight: 42, flex: 1, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.line, borderRadius: 13, backgroundColor: colors.white }, cancelButtonText: { color: colors.text, fontSize: 11, fontWeight: "700" }, dangerButton: { minHeight: 42, flex: 1, alignItems: "center", justifyContent: "center", borderRadius: 13, backgroundColor: colors.red }, dangerButtonText: { color: colors.white, fontSize: 11, fontWeight: "700" },
});
