...
const styles = StyleSheet.create({
  page: { flex: 1, backgroundColor: colors.white }, keyboard: { flex: 1 }, header: { minHeight: 65, flexDirection: "row", alignItems: "center", gap: 9, paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: colors.line }, avatar: { position: "relative", width: 41, height: 41, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: colors.mint50 }, dot: { position: "absolute", right: -2, bottom: -2, width: 11, height: 11, borderRadius: 6, borderWidth: 2, borderColor: colors.white, backgroundColor: "#AAB6C0" }, dotOnline: { backgroundColor: colors.mint }, headerCopy: { flex: 1 }, name: { color: colors.navy, fontSize: 12, fontWeight: "900" }, status: { marginTop: 3, color: colors.mint, fontSize: 8 }, iconButton: { width: 35, height: 35, borderRadius: 11, borderWidth: 1, borderColor: colors.line, alignItems: "center", justifyContent: "center" }, tabs: { flexDirection: "row", gap: 6, padding: 8, backgroundColor: colors.canvas }, tab: { flex: 1, minHeight: 38, alignItems: "center", justifyContent: "center", borderRadius: 10 }, activeTab: { borderWidth: 1, borderColor: colors.line, backgroundColor: colors.white }, tabText: { color: colors.muted, fontSize: 9, fontWeight: "800" }, activeTabText: { color: colors.sky600 }, context: { flexDirection: "row", alignItems: "center", gap: 9, padding: 9, paddingHorizontal: 14, backgroundColor: "#F7FBFD" }, pet: { width: 34, height: 34, borderRadius: 10, overflow: "hidden", backgroundColor: "#FFF0D8", fontSize: 20, textAlign: "center", lineHeight: 34 }, contextCopy: { flex: 1 }, contextLabel: { color: colors.muted, fontSize: 7, fontWeight: "900" }, contextName: { marginTop: 3, color: colors.navy, fontSize: 9, fontWeight: "800" }, petOnly: { padding: 5, borderRadius: 7, backgroundColor: colors.mint50 }, petOnlyText: { color: colors.mint, fontSize: 7, fontWeight: "900" }, messages: { flexGrow: 1, padding: 15, backgroundColor: colors.canvas }, scope: { flexDirection: "row", gap: 7, padding: 10, marginBottom: 10, borderRadius: 11, backgroundColor: colors.sky50 }, scopeText: { flex: 1, color: colors.muted, fontSize: 8, lineHeight: 12 }, messageRow: { flexDirection: "row", alignItems: "flex-end", gap: 6, marginTop: 10 }, messageRowMe: { justifyContent: "flex-end" }, messageAvatar: { width: 26, height: 26, borderRadius: 8, overflow: "hidden", backgroundColor: colors.mint50, textAlign: "center", lineHeight: 26 }, bubble: { maxWidth: "82%", padding: 11, borderWidth: 1, borderColor: colors.line, borderRadius: 13, borderBottomLeftRadius: 4, backgroundColor: colors.white }, bubbleMe: { borderWidth: 0, borderBottomLeftRadius: 13, borderTopRightRadius: 4, backgroundColor: colors.sky500 }, messageText: { color: colors.text, fontSize: 10, lineHeight: 15 }, messageTextMe: { color: colors.white }, loader: { alignSelf: "flex-start", margin: 15 }, quick: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 13, paddingLeft: 32 }, composer: { minHeight: 65, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 13, borderTopWidth: 1, borderTopColor: colors.line }, attach: { width: 35, height: 35, borderRadius: 11, alignItems: "center", justifyContent: "center", backgroundColor: "#EFF4F7" }, input: { flex: 1, height: 41, paddingHorizontal: 11, borderWidth: 1, borderColor: colors.line, borderRadius: 12, color: colors.text, fontSize: 10 }, send: { width: 35, height: 35, borderRadius: 11, alignItems: "center", justifyContent: "center", backgroundColor: colors.sky500 }, loaderSpacer: { height: 5 },
});
