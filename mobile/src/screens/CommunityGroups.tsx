...
const styles = StyleSheet.create({
  ...
  scopeText: { color: colors.muted, fontSize: 11, fontWeight: "800" },
  ...
  groupName: { minWidth: 0, flex: 1, color: colors.navy, fontSize: 13, fontWeight: "900" },
  ...
  sheetTitle: { marginTop: 2, color: colors.navy, fontSize: 18, fontWeight: "900" },
  close: { width: 40, height: 40, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.line, borderRadius: 13 },
  inputLabel: { marginTop: 10, marginBottom: 5, color: colors.navy, fontSize: 10, fontWeight: "900" },
  ...
  roomTitle: { color: colors.navy, fontSize: 14, fontWeight: "900" },
  ...
  senderName: { marginBottom: 2, color: colors.sky600, fontSize: 9, fontWeight: "900" },
