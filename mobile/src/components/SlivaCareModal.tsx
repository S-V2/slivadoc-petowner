...
const styles = StyleSheet.create({
  ...
  messages: { flexGrow: 1, padding: 14, paddingBottom: 18, backgroundColor: colors.canvas }, scope: { flexDirection: "row", gap: 7, padding: 10, marginBottom: 9, borderRadius: 13, backgroundColor: colors.sky50 }, scopeText: { flex: 1, color: colors.muted, fontSize: 10, lineHeight: 16 }, messageRow: { flexDirection: "row", alignItems: "flex-end", gap: 6, marginTop: 9 }, messageRowMe: { justifyContent: "flex-end" }, messageAvatar: { width: 26, height: 26, borderRadius: 9, alignItems: "center", justifyContent: "center", backgroundColor: colors.mint50 }, bubble: { maxWidth: "84%", padding: 10, borderWidth: 1, borderColor: colors.line, borderRadius: 14, borderBottomLeftRadius: 4, backgroundColor: colors.white }, bubbleMe: { borderWidth: 0, borderBottomLeftRadius: 14, borderTopRightRadius: 4, backgroundColor: colors.sky500 }, messageText: { color: colors.text, fontSize: 13, lineHeight: 19 }, messageTextMe: { color: colors.white }, loader: { alignSelf: "flex-start", margin: 12 }, quick: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 11, paddingLeft: 31 }, quickButton: { minHeight: 38, flexDirection: "row", alignItems: "center", gap: 6, justifyContent: "center", paddingHorizontal: 10, borderWidth: 1, borderColor: colors.line, borderRadius: 11, backgroundColor: colors.white }, quickText: { color: colors.text, fontSize: 10, fontWeight: "700" },
